...
DEFAULT_CATALOG = {
    'Plumbing': {
        'materials': {
            'CPVC': {
                'sizes': ['3/4"', '1"', '1.5"'],
                'fittings': ['pipe', 'Elbow', 'Tee', 'Union', '45 Deg', 'Gate Valve', 'Socket', 'Reducer', 'End Cap', 'Female Socket', 'Female Elbow', 'Female Tee', 'Male Socket', 'Long-Plug', 'Reducer Elbow', 'Reducer Tee', 'Over bend', 'Cross Tee', 'Tank Nipple', 'Mixer Adapter', 'Solvent'],
            },
            'PVC': {
                'sizes': ['1.5"', '2.5"', '4"', '6"'],
                'fittings': ['pipe', 'Elbow', 'Tee', '45 Deg', 'Socket', 'Reducer', 'End Cap', 'P-Trap', 'Trap', 'Reducer Elbow', 'Reducer Tee', 'Jali', 'Door Elbow', 'Door Tee', 'Solvent'],
            },
            'Black': {
                'sizes': ['3"', '4"', '6"'],
            ...
            'GI': {
                ...
                'fittings': ['pipe', 'Nipple', 'Elbow', 'Tee', 'Union', '45 Deg', 'Gate Valve', 'Socket', 'Reducer', 'End Cap', 'Female Socket', 'Female Elbow', 'Female Tee', 'Male Socket', 'Reducer Elbow', 'Reducer Tee', 'Tank Nipple'],
            },
            'Tank': {'sizes': ['200L', '500L', '750L', '1000L'], 'fittings': []},
            'Passion': {'sizes': ['Wall Mixer', 'Bib-Cock', 'Angle-Cock', 'Swan Neck', 'Long Body', 'Piller Cock', 'Non-Telephone', 'Gun', 'Shower', 'CV fringes'], 'fittings': []},
    ...
    'Wiring': {
        'materials': {
            'Wire': {'sizes': ['Rathi Gold', 'Rathi RC', 'Copper', 'meter_wire'], 'fittings': ['0.75"', '1"', '1.5"', '2.5"', '4"', '6"', '10"']},
            'Switch board': {'sizes': ['Gold', 'Platinium', 'MG-Gold', 'Heavy'], 'fittings': ['5X3 4-Gang', '5X3 6-Gang', '5X3 8-Gang', '5X3 10-Gang', '3X3 4-Gang', '3X3 3-Gang', '3X3 2-Gang', '3X3 1-Gang', '3X3 Power-Socket', '3X5 Double Power-Socket', '3X3 main Switch', '3X5 main Switch']},
            'Modular': {'sizes': ['6A', '16A', '20A', '32A', '3X3 plate', '4X3 plate', '5X3 plate', '7X3 plate', '8X4 plate', '5X5 plate'], 'fittings': ['Switch', 'Indicator', '5-pin', '2-Pin', 'Fan Regulator']},
            'Box': {'sizes': ['3X3 Mounting', '3X5 Mounting', '3X3 Surface', '3X5 Surface', 'PVC 4X4', 'Plate 4X4', 'PVC 7X4', 'Plate 12X8'], 'fittings': []},
            'MCB': {'sizes': ['SP', 'DP'], 'fittings': ['6A', '10A', '16A', '20A', '32A', '40A']},
            'MCB-Box': {'sizes': ['2-Way', '6-Way', '8-Way', '10-Way', '12-Way', '14-Way', '16-Way', '20-Way TPN'], 'fittings': []},
            'Pipe': {'sizes': ['Black 16mm', 'Black 20mm', 'Black NS 16mm', 'Black NS 20mm', 'white NS 20mm', 'White NS 16mm'], 'fittings': []},
            'Single': {'sizes': ['Switch', '5-Pin Socket', '2-pin Socket', 'Indicator', 'Fuse', 'Regulator'], 'fittings': []},
            'Wire Beet': {'sizes': ['16mm', '20mm', '25mm', '30mm', '35MM'], 'fittings': []},
            'Screw': {'sizes': ['3/4"', '1"', '1.5"', '2"', '2.5"', '3"', '4"', '6"'], 'fittings': []},
            'Fiber-plate': {'sizes': ['4x4', '5x5', '7x4', '7X5', '12X8'], 'fittings': []},
            'Cutting Blade': {'sizes': [], 'fittings': []},
            'J-hook': {'sizes': [], 'fittings': []},
            'Tape': {'sizes': [], 'fittings': []},
    ...
    'Tin': {
        'materials': {
            'Aarti Color': {'sizes': ['36mm', '30mm', '24mm', '19mm', '42mm'], 'fittings': ['6Ft', '7Ft', '8Ft', '9Ft', '10Ft', '12Ft']},
            'Aarti White': {'sizes': ['42mm', '39mm', '36mm', '32mm', '30mm', '26mm', '24mm', '19mm', '13mm'], 'fittings': ['6Ft', '7Ft', '8Ft', '9Ft', '10Ft', '12Ft']},
    ...
    'Ply': {
        'materials': {
            '18mm': {'sizes': ['(8X4)', '(7X4)', '(6X4)', '(5X4)', '(8X3)', '(7X3)', '(6X3)', '(5X3)'], 'fittings': ['1', '2', '3', '4', '5', '6', '10', '20', '30', '40']},
...
@transaction.atomic
def seed_default_catalog_for_user(user):
    counts = {
        'categories': 0,
        'materials': 0,
        'sizes': 0,
    ...
    for category_name, category_data in DEFAULT_CATALOG.items():
        ...
        for material_name, material_data in category_data['materials'].items():
            ...
            for size_value in material_data['sizes']:
            ...
            for fitting_name in material_data['fittings']:
                fitting, fitting_created = Fitting.objects.get_or_create(
                    owner=user,
                    material=material,
                    name=fitting_name,
                    defaults={'active': True},
